    ...
    value: function _loadImages() {
      ...
      setTimeout(function () {
        if ((0, _util.imageLoaded)(image)) {
          ...
          _this9._events.imageLoad = (0, _util.assignEvent)(image, 'load', onImageLoad);
        }
      }, 0);
    }
  }, {
    ...
    value: function _loadHighResImage(hiResImageSrc) {
      ...
      setTimeout(function () {
        if ((0, _util.imageLoaded)(hiResImage)) {
          ...
          _this10._events.hiResImageLoad = (0, _util.assignEvent)(hiResImage, 'load', onHighResImageLoad);
        }
      }, 0);
    }
  }, {
